...
import { collection, query, where, getDocs, addDoc, doc, updateDoc, getDoc, onSnapshot } from 'firebase/firestore';
import db, { auth } from '../Components/firebase';
import { generateJoinCode, setActiveSession, formatSessionCode } from './sessionUtils';
